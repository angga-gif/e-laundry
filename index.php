...
<html lang="en">
  ...
  <body>
    ...
    <header class="jumbotron bg-inverse text-xs-center center-vertically" role="banner">
      <div class="container">
        <h1 class="display-3">Aplikasi Laundry  </h1>
        <h2 class="m-b-3">Bersih, <em>Wangi</em>, dan Ekonomis <br></h2>
        <a class="btn btn-secondary-outline m-b-1" href="login/index.php" role="button"><span class="icon-user"></span>Login</a>
